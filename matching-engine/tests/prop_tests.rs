...
// fn make_limit(id: usize, trader: u32, side: Side, price: i64, qty: u64) -> Order {
//     Order::new(id, trader, side, OrderType::Limit, price, qty, qty, 0)
// }

// fn make_market(id: usize, trader: u32, side: Side, qty: u64) -> Order {
//     Order::new(id, trader, side, OrderType::Market, 1, qty, qty, 0)
// }

// fn make_ioc(id: usize, trader: u32, side: Side, price: i64, qty: u64) -> Order {
//     Order::new(id, trader, side, OrderType::IOC, price, qty, qty, 0)
// }

// fn make_fok(id: usize, trader: u32, side: Side, price: i64, qty: u64) -> Order {
...
//         let trades = match_order(&mut book, make_limit(bid_id, 2, Side::Buy, price, bid_qty));
...
//         let bid_id = book.allocate_id();
//         match_order(&mut book, make_limit(bid_id, 2, Side::Buy, price, bid_qty));
...
//         let ask_id = book.allocate_id();
//         match_order(&mut book, make_limit(ask_id, 2, Side::Sell, price, ask_qty));
...
//         let bid_id = book.allocate_id();
//         match_order(&mut book, make_limit(bid_id, 2, Side::Buy, bid_price, bid_qty));
...
//         let bid_id = book.allocate_id();
//         let trades = match_order(&mut book, make_fok(bid_id, 2, Side::Buy, price, fok_qty));
...
//         match_order(&mut book, make_ioc(ioc_id, 2, Side::Buy, price, ioc_qty));
...
//         match_order(&mut book, make_market(mkt_id, 2, Side::Buy, mkt_qty));
...
//         let bid_id = book.allocate_id();
//         let trades = match_order(&mut book, make_limit(bid_id, 3, Side::Buy, price, bid_qty));
...
//         let bid_id = book.allocate_id();
//         let trades = match_order(&mut book, make_limit(bid_id, 42, Side::Buy, price, qty));
