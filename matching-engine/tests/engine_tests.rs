...
// fn lim(id: usize, trader: u32, side: Side, price: i64, qty: u64) -> Order {
//     Order::new(id, trader, side, OrderType::Limit, price, qty, qty, 0)
// }

// fn mkt(id: usize, trader: u32, side: Side, qty: u64) -> Order {
//     Order::new(id, trader, side, OrderType::Market, 0, qty, qty, 0)
// }

// fn ioc(id: usize, trader: u32, side: Side, price: i64, qty: u64) -> Order {
//     Order::new(id, trader, side, OrderType::IOC, price, qty, qty, 0)
// }

// fn fok(id: usize, trader: u32, side: Side, price: i64, qty: u64) -> Order {
...
// fn rest_bid(book: &mut OrderBook, trader: u32, price: i64, qty: u64) -> usize {
...
// fn rest_ask(book: &mut OrderBook, trader: u32, price: i64, qty: u64) -> usize {
//     let id = book.allocate_id();
...
//     let id = book.allocate_id();
//     let trades = match_order(&mut book, lim(id, 2, Side::Buy, 100, 10));
...
//     let id = book.allocate_id();
//     let trades = match_order(&mut book, lim(id, 2, Side::Sell, 100, 10));
...
//     let trades = match_order(&mut book, taker);
...
//     let trades = match_order(&mut book, lim(id, 2, Side::Buy, 100, 10)); // wants 10
...
//     let trades = match_order(&mut book, lim(id, 2, Side::Buy, 100, 5)); // wants 5
...
//     let trades = match_order(&mut book, lim(id, 2, Side::Buy, 102, 30));
...
//     let trades = match_order(&mut book, lim(id, 3, Side::Buy, 100, 5));
...
//     let trades = match_order(&mut book, lim(id_1, 3, Side::Buy, 100, 5));
...
//     let trades = match_order(&mut book, lim(id, 2, Side::Buy, 104, 10));
...
//     let trades = match_order(&mut book, mkt(id, 2, Side::Buy, 10));
...
//     let trades = match_order(&mut book, mkt(id, 2, Side::Buy, 20));
...
//     let trades = match_order(&mut book, mkt(id, 1, Side::Buy, 10));
...
//     let trades = match_order(&mut book, mkt(id, 2, Side::Buy, 10)); // wants 10
...
//     let trades = match_order(&mut book, mkt(id, 2, Side::Sell, 10));
...
//     let trades = match_order(&mut book, ioc(id, 2, Side::Buy, 100, 10));
...
//     let trades = match_order(&mut book, ioc(id, 2, Side::Buy, 100, 10)); // wants 10
...
//     let trades = match_order(&mut book, ioc(id, 2, Side::Buy, 100, 10)); // bid at 100
...
//     let trades = match_order(&mut book, ioc(id, 2, Side::Buy, 102, 20));
...
//     let trades = match_order(&mut book, fok(id, 2, Side::Buy, 100, 10));
...
//     let trades = match_order(&mut book, fok(id, 2, Side::Buy, 100, 10)); // wants 10
...
//     let trades = match_order(&mut book, fok(id, 2, Side::Buy, 101, 10));
...
//     let trades = modify_order(&mut book, id, 100, 10).unwrap();
...
//     let trades = modify_order(&mut book, bid_id, 100, 10).unwrap();
...
//     let trades = modify_order(&mut book, 9999, 100, 10).unwrap();
//     assert!(trades.is_empty());
// }
...
//     let trades = match_order(&mut book, lim(id, 1, Side::Buy, 100, 10));
...
//     let trades = match_order(&mut book, lim(id, 1, Side::Buy, 100, 20));
...
//     match_order(&mut book, lim(id, 2, Side::Buy, 100, 10)); // drains 100
...
//     let trades = match_order(&mut book, lim(id, 2, Side::Buy, 101, 15));
...
//     let trades = match_order(&mut book, lim(id, 2, Side::Buy, 101, 10));
